...
func (m *Method) ReasoningEffort(requestJson string) (bool, string) {
	reasoningEffortResult := gjson.Get(requestJson, "reasoning_effort")
	if reasoningEffortResult.Type == gjson.String {
		return true, reasoningEffortResult.String()
	}
	return false, ""
}
